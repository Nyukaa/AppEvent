...
function tourcatalog_shortcode($attr) {
   ...
   if ($loop->have_posts()) : 
        while ($loop->have_posts()) : $loop->the_post();
            ...
            $text .= '<section class="tour" data-category="' . esc_attr($main_cat) . '" data-time="' . esc_attr($time) . '" data-place="' . esc_attr($place) . '" data-forwhom="' . esc_attr($forwhom) . '" data-language="' . esc_attr($language) . '">';
